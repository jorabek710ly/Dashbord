        ...
        <div className='text-white flex flex-col gap-[12px] sm:gap-[20px]'>
          ...
          <ul className='flex flex-col gap-[12px]'>
            <li className='flex items-center gap-3 text-[#9198a1] hover:text-[#3b82f6] cursor-pointer text-[14px] sm:text-[16px]'>
              <FaPhoneAlt size={18} />
              <a href="tel:+998901234567" className='underline'>+998 94 939 85 96</a>
            </li>
            <li className='flex items-center gap-3 text-[#9198a1] hover:text-[#3b82f6] cursor-pointer text-[14px] sm:text-[16px]'>
              <FaTelegramPlane size={18} />
              <a href="https://t.me/username" target="_blank" rel="noopener noreferrer" className='underline'>@baxad1rovich710lv</a>
            </li>
            <li className='flex items-center gap-3 text-[#9198a1] hover:text-[#3b82f6] cursor-pointer text-[14px] sm:text-[16px]'>
              <FaInstagram size={18} />
              <a href="https://instagram.com/username" target="_blank" rel="noopener noreferrer" className='underline'>@jorabek710lv
              </a>
            </li>
          </ul>
